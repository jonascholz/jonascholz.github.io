...
Note that we have assumed here that the layer consists of a single neuron with 1 input. As a result, the $$\textcolor{blue}{\alpha}$$ and $$\textcolor{brown}{\theta}$$ are 1-dimensional arrays, and $$\textcolor{red}{W}$$ is a 1x1 matrix.
